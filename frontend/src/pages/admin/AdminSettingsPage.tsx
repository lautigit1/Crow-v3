...
import { useSettingsQuery, useUpdateSettingsMutation } from "@/entities/settings/queries";
import { apiError } from "@/shared/api";

export function AdminSettingsPage() {
  // Mismo query que lee el resto del sitio (footer, navbar, checkout, etc.)
  // -- al guardar, la mutation actualiza esta cache directamente (ver
  // `useUpdateSettingsMutation`), así que el resto de las pestañas/páginas
  // ven el cambio la próxima vez que monten, sin esperar el staleTime.
  ...
  return (
    <div>
      ...
      {isError ? (
        <div className="font-body text-[13px] text-danger">No se pudo cargar la configuración.</div>
      ) : !form ? (
